...
EXPORTS='["_ha_reset","_ha_reset_at","_ha_reset_keep_known","_ha_set_admission_full","_ha_tick","_ha_input","_ha_input_at","_ha_disconnect","_ha_pause","_ha_resume","_ha_resume_expire","_ha_time_reached","_ha_time_remaining","_ha_select_game","_ha_trivia_clear","_ha_trivia_add_topic","_ha_trivia_add_q","_ha_round_end","_ha_reset_scores","_ha_drain","_ha_content_clear","_ha_content_lose_stage","_ha_content_pack","_ha_content_item","_ha_content_commit","_ha_content_commit_expected","_ha_set_lang","_ha_chess_load","_ha_chess_perft"]'
