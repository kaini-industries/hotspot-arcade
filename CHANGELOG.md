...
- **Browser protocol v2 and firmware v21 identity foundation.** Each browser now creates
  a cryptographically random 128-bit resume credential and sends it in an explicit v2
